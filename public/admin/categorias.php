...
if ($db) {
    try {
        ...
        $query = "SELECT e.id, e.nombre, e.fecha, e.estado, 
                  ...
                  FROM eventos e 
                  LEFT JOIN categorias c ON e.id = c.evento_id 
                  GROUP BY e.id 
...
<head>
    ...
    <title>Gestión de Categorías - Sistema de Votación</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="header">
            <h1>🏷️ Gestión de Categorías por Evento</h1>
            <p>Seleccione un evento para gestionar sus criterios de evaluación</p>
        </div>
        ...
        <?php if (empty($eventos)): ?>
            <div class="no-data">
                ...
                <p>Comienza creando el primer evento para configurar categorías</p>
            ...
            <div class="eventos-grid">
                ...
                <div class="evento-card">
                    ...
                    <div class="evento-stats">
                        <div class="stat">
                            <div class="stat-number"><?php echo $evento['total_categorias']; ?></div>
                            <div class="stat-label">Categorías</div>
                        </div>
                        <div class="stat">
                            <div class="stat-number">10</div>
                            <div class="stat-label">Puntaje Máx</div>
                        </div>
                        <div class="stat">
                    ...
                    <div class="evento-actions">
                        <a href="gestionar_categorias.php?evento_id=<?php echo $evento['id']; ?>" class="btn btn-success btn-small">
